package com.example.unsplash.ui.screens.common
...
import com.example.unsplash.model.Links
...
import com.example.unsplash.ui.theme.HeartRed


@OptIn(ExperimentalCoilApi::class)
@Composable
fun ListContent(items: LazyPagingItems<UnsplashImage>) {
    Log.d("ErrorState", items.loadState.toString())
    LazyColumn(
